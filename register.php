    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          ...
          <!-- change -->
          <div>
                      <span style="font-size:21px; font-weight:bold; display: inline; 
                      margin-bottom: 10px;">Register Form</span>
                    ...
                    <div>
                      <form  method="post">
                      <label>Name </label><br>
                      <input type="text" name="t1" id="t1" class="input_field" /><br>
                      <label>Email</label><br>
                      <input type="email" name="t2" id="t2" class="input_field" /><br>
                      <label>Password</label><br>
                      <input type="password" name="t3" id="t3" class="input_field" /><br>
                      <label>Phone </label><br>
                      <input type="text" name="t4" id="t4" class="input_field" /><br>
                      <label>City </label><br>
                      <input type="text" name="t5" id="t5" class="input_field" /><br>
                      <label>Township </label><br>
                      <input type="text" name="t6" id="t6" class="input_field" /><br><br>
