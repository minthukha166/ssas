...
if(isset($_POST['sub'])){
  ...
  $price=$_POST['t2'];
  if($prono == '' && $price ==''){
    $mashipr = 'Please fill the food name and price to insert..!';
    echo "$mashipr";
  } else {
    $qry="INSERT INTO item (id,img,food_name,price) VALUES ('','$img','$prono','$price')";
  $result=mysql_query($qry) or die ("save items query fail.");
  if($result)			
	   {mkdir("assets/img/food");
			move_uploaded_file($_FILES['img']['tmp_name'],"assets/img/food/".$_FILES['img']['name']);	
...
<section id="hero" class="hero d-flex align-items-center section-bg">
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          ...
          <!-- change -->
          <h2 data-aos="fade-up" >Hello! Welcome Insert.</h2>
	...
	<div id="contact_form" class="col_2">
            ...
            <table  width="600px" align="left">
				...
				<tr>
				  <td><span class="style3">Food name: </span></td>
				  <td><label>
