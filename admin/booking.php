    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          ...
          <!-- change -->
          <h2 data-aos="fade-up" >Hello! Welcome.</h2>
          <h3 data-aos="fade-up" >View Order</h3>
          <div id="tooplate_main">
       <table  align="left" >
					
					<tr>				
						<th width="100px" height="50px">Id:</th>
						<th width="100px" height="50px">Food:</th>
						<th width="100px" height="50px">Price:</th>
						<th width="100px" height="50px">Name:</th>
            <th width="100px" height="50px">Ph No:</th>
...
<!--</div> <!-- END of tooplate_wrapper -->
        ...
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="assets/img/hero-img3.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
